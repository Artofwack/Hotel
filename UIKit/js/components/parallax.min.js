...
!function (t) {
    ...
    function e(e, a, r) {
        ...
        return i = e.element.css({
            ...
            return n += o, t += Math.ceil(o * c), t - o > s.w && n < s.h ? e.element.css({"background-size": ""}) : (n > t / c ? (p = Math.ceil(n * c), l = n, n > window.innerHeight && (p = 1.2 * p, l = 1.2 * l)) : (p = t, l = Math.ceil(t / c)), i.css({"background-size": p + "px " + l + "px"}).data("bgsize", {
                w: p,
                h: l
            }), void 0)
        }, d.onerror = function () {
    ...
    var i = [], s = !1, o = 0, c = window.innerHeight, p = function () {
    ...
    t.component("parallax", {
        defaults: {velocity: .5, target: !1, viewport: !1, media: !1}, boot: function () {
            ...
            var r, n, i = {transform: ""}, o = t * (1 - (this.velocity - this.velocity * t));

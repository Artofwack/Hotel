		...
		<div class="item active">
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>Sign in or register to make a reservation.</p>
...
<div class="container marketing">
	...
	<div class="row featurette" id="about">
		<div class="col-md-7" data-uk-scrollspy="{cls:'uk-animation-slide-left', repeat: true}">
		...
		<div class="col-md-5" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat: true}">
	...
	<div class="row featurette">
		...
		<div class="col-md-5 col-md-pull-7" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat: true}">
			<img class="featurette-image img-responsive center-block" data-src="holder.js/500x500/auto"
			     src="../images/costa-sur-resort-and-spa-1.jpg"
			     alt="Generic placeholder image">
		</div>
	...
	<div class="row featurette" id="contact">
		<div class="col-md-7" data-uk-scrollspy="{cls:'uk-animation-slide-bottom', repeat: true}">
